...
OpenLayers.ProxyHost = "/bpn2015/heron/cgi-bin/proxy.cgi?url=";
...
//	May use new NASA WMTS : http://onearth.jpl.nasa.gov/wms.cgi?request=GetCapabilities
    ...
    new OpenLayers.Layer.WMS(
            "Batas Kecamatan",
            'http://192.168.1.113:8080/geoserver/wms',
            {layers: "BPN2015:Administrasi_Majene_Kecamatan", transparent: true, format: 'image/png'},
    ...
    new OpenLayers.Layer.WMS(
            "Jalan",
            'http://192.168.1.113:8080/geoserver/wms',
            {layers: "BPN2015:Jalan_Majene", transparent: true, format: 'image/png'},
            {singleTile: true, opacity: 0.9, isBaseLayer: false, visibility: false, noLegend: false, transitionEffect: 'resize', metadata: {
                wfs: {
                    protocol: 'fromWMSLayer'
                }
    ...
    new OpenLayers.Layer.Vector("Admin WFS", {
        minScale: 15000000,
        strategies: [new OpenLayers.Strategy.BBOX()],
        visibility: true,
        protocol: new OpenLayers.Protocol.WFS({
            url: 'http://192.168.1.113:8080/geoserver/wfs',
            featurePrefix: 'BPN2015',
            featureType: "Administrasi_Majene_Kecamatan",
            featureNS: 'http://192.168.1.113:8080/bpn2015',
            srsName : "EPSG:4326"
        })
    }),
    new OpenLayers.Layer.WMS(
